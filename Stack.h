...
// Parth, a stack is not an array and therefore the incorrect composition
// approach. Moreover, a user of the stack as access to the array's public
// method, which can break your stack's implementation. Change this to
// aggregation.
//
// Dr. Hill, I realize the mistake and used aggregation by using a stack
// allocated array inside the queue.
...
private:
  ...
  size_t cur_size_;
  // Size allocated in memory for future expansion
  size_t alloc_size_;
};
